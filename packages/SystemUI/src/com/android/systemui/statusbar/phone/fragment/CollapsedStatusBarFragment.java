...
public class CollapsedStatusBarFragment extends Fragment implements CommandQueue.Callbacks,
    ...
    private ImageView mColtLogo;
    private ImageView mColtLogoRight;
    ...
    private void hideEndSideContent(boolean animate) {
        ...
        if (mShowLogo == 2) {
            animateHide(mColtLogoRight, animate, false);
        }
    ...
    private void showEndSideContent(boolean animate) {
        ...
        if (state == IDLE || state == SHOWING_PERSISTENT_DOT) {
            ...
            if (mShowLogo == 2) {
                animateShow(mColtLogoRight, animate);
    ...
    public void updateLogoSettings(boolean animate) {
        ...
        if (!TextUtils.isEmpty(customSbLogoURI) && mCustomSbLogoEnabled) {
            ...
            try {
                ...
                if (mShowLogo == 1) {
                    mColtLogoRight.setImageDrawable(null);
                    mColtLogoRight.setVisibility(View.GONE);
                    mColtLogo.setImageDrawable(null);
                    mColtLogo.setImageBitmap(imageSbLogo);
                    mColtLogo.setVisibility(View.VISIBLE);
                } else if (mShowLogo == 2) {
                    mColtLogo.setImageDrawable(null);
                    mColtLogo.setVisibility(View.GONE);
                    mColtLogoRight.setImageDrawable(null);
                    mColtLogoRight.setImageBitmap(imageSbLogo);
                    mColtLogoRight.setVisibility(View.VISIBLE);
                }
            }
            catch (Exception e) {
            }
            ...
            switch(mLogoStyle) {
                    // Colt Old
                case 1:
                    logo = getContext().getResources().getDrawable(R.drawable.ic_colt_logo);
                    break;
                    // XTND Short
                case 2:
            ...
            if (mShowLogo == 0) {
                ...
                mColtLogoRight.setVisibility(View.GONE);
                mColtLogo.setVisibility(View.VISIBLE);
                mColtLogo.setImageDrawable(logo);
                if (mLogoColor == 0xFFFFFFFF) {
                    mColtLogo.setColorFilter(mTintColor, PorterDuff.Mode.MULTIPLY);
                } else {
                    mColtLogo.setColorFilter(mLogoColor, PorterDuff.Mode.MULTIPLY);
                }
            } else if (mShowLogo == 2) {
                mColtLogo.setImageDrawable(null);
                mColtLogo.setVisibility(View.GONE);
                mColtLogoRight.setVisibility(View.VISIBLE);
                mColtLogoRight.setImageDrawable(logo);
                if (mLogoColor == 0xFFFFFFFF) {
                    mColtLogoRight.setColorFilter(mTintColor, PorterDuff.Mode.MULTIPLY);
                } else {
                    mColtLogoRight.setColorFilter(mLogoColor, PorterDuff.Mode.MULTIPLY);
                }
            }
        }
    }
